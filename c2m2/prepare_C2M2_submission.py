...
# Lastmod date unless I forgot to change it: 2022-04-04
# 
##########################################################################################
...
submissionDraftDir = 'rmh_2022_04_11'
...
def decorateTermsUsed(  ):
    ...
    # Start with phenotype: these terms determine sets of extra gene and disease terms autoloaded
    # into phenotype_gene and phenotype_disease, and we don't want to have to scan the other two
    # reference files twice, so we collect the associations from the HPO data first.
    ...
    with open( mapFile, 'r' ) as IN:
        ...
        for line in IN:
            ...
            for ensembl_id in ensembl_id_array:
                ...
                if not ( re.search(r'^ENSG', ensembl_id) is None ):
    ...
    for categoryID in categories:
        ...
        elif categoryID == 'anatomy' or categoryID == 'assay_type' or categoryID == 'analysis_type' or categoryID == 'disease':
        ...
        with open(outFile, 'w') as OUT:
            ...
            for termID in sorted( termsUsed[categoryID] ):
                ...
                if 'name' in termsUsed[categoryID][termID] and termsUsed[categoryID][termID]['name'] != '':
                    ...
                    # (There are some HPO gene targets that don't map to our Ensembl version. Last count was five IDs. Skipping until data sync fixes the issue.)
