...
# Mis mejores 8 deseos con consejos
...
Colorbrewer[^1a] te ayuda a elegir colores amigables para el daltónico

![](../figures/talk/colorbrewer.png){width=75%}

[^1a]: http://colorbrewer2.org/

# Ejemplos de paleta de colores
...
# Convertir HEX a RGB si necesita

![](../figures/talk/orange.png){width=50%}

![](../figures/talk/teal.png){width=50%}


![](../figures/talk/purple.png){width=50%}
[^1b]

[^1b]: https://www.webpagefx.com/web-design/hex-to-rgb/

# Confirme que tu palet es amigable con los daltónicos
...
# Deseo 4: Usa el control de versiones para la colaboración con otros y con vos en el futuro
...
# Deseo 6: Me ayuda mejor las nuevas lecciones en español de Software Carpentry
...
>- Haga videos de usted leyendo y codificando junto con la lección[^6c]
...
- Aplica aquí: http://carpentries.github.io/instructor-training/

![](../figures/talk/joinus.png){width=75%}
[^7] 
...
![](../figures/talk/workshops.png){width=75%}
[^8] 

[^8]: https://software-carpentry.org/workshops/


# ¡Gracias por tu atención! ¡Mantengamonos en contacto!
