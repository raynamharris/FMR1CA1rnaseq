...
\includegraphics[width=0.50000\textwidth]{../figures/10_talk/trabajo-tiempo-8.png}
...
\includegraphics[width=0.50000\textwidth]{../figures/10_talk/tiempo-01.png}

\end{frame}

\begin{frame}{La enseñanza colaborativa también ahorra tiempo}

\includegraphics[width=0.50000\textwidth]{../figures/10_talk/tiempo-02.png}

\end{frame}

\begin{frame}{Mi filosofía}
...
\item
  Use \textbf{cowplot}\footnote<.->{\url{https://software-carpentry.org/lessons/}}
