...
\includegraphics{../figures/talk/swc3.png} \footnote<.->{\textbf{cowplot}
...
\begin{frame}{Convertir HEX a RGB si necesita}

\includegraphics[width=0.50000\textwidth]{../figures/talk/orange.png}

\includegraphics[width=0.50000\textwidth]{../figures/talk/teal.png}

\includegraphics[width=0.50000\textwidth]{../figures/talk/purple.png}
\footnote<.->{\url{https://www.webpagefx.com/web-design/hex-to-rgb/}}

\end{frame}

\begin{frame}{Confirme que tu palet es amigable con los daltónicos}

colorblindr\footnote<.->{\url{https://github.com/clauswilke/colorblindr}}
simula deficiencias de visión del color

\includegraphics[width=225px]{../figures/talk/colorblindgrid-1}
...
\begin{frame}{Deseo 4: Usa el control de versiones para la colaboración
...
\includegraphics[width=0.75000\textwidth]{../figures/talk/joinus.png}
...
\includegraphics[width=0.75000\textwidth]{../figures/talk/workshops.png}
