...
This next graph is a big overview that shows that consistent trained aniamls avoid the shock zone and the clockwise area while conflict avoid the shock zone and counter clockwise. This is re-illustrated in the subsequent graph focusing just on the conlict training sessions. Yoked mice show no place preference or avoidance.
...
pdf(file="../figures/01_behavior/timespent3.pdf", width=2.5, height=2.25)
plot(timespent3)
dev.off()
...
pdf(file="../figures/01_behavior/timespent4.pdf", width=2.5, height=2.25)
plot(timespent4)
dev.off()
...
```{r proportiontimespenttrained, echo=F, warning=F}
