...
ephys2summaryNum$APA2 <- factor(ephys2summaryNum$APA2,
                      levels = c("control-consistent","consistent","control-conflict", "conflict"))
...
levels(ephys2$APA2) <- c("yoked-consistent","consistent", "yoked-conflict", "conflict")
levels(ephys2_long$APA2) <- c("yoked-consistent","consistent", "yoked-conflict", "conflict")
levels(ephys2summaryNum$APA2) <- c("yoked-consistent","consistent", "yoked-conflict", "conflict")
ephys2$genoAPA <- as.factor(paste(ephys2$Genotype,ephys2$APA2,sep="_"))
