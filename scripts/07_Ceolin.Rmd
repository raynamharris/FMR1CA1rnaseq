...
knitr::opts_chunk$set(fig.path = '../figures/07_Ceolin/')
```
...
ann_colors <- list(
  genotype =  c('FMR1_KO' = (values=c("white")), 
            'WT' = (values=c("#404040"))))
...
pheatmap(DEGes, show_colnames=F, show_rownames = T,
         ...
         breaks=myBreaks,
         clustering_method="average",
         filename = "../figures/07_Ceolin/HeatmapPadj-1.pdf"
         )
...
write.csv(GOpvals, "./06_GO_MWU/07_Ceolin_GOpvals.csv", row.names = F)
```
...
colored <- ggplot(data, aes(x = lfc, y = pvalue)) + 
  ...
  scale_color_manual(values = c("FRM1_KO" = "black",
                                "WT" = "black", 
...
pdf(file="../figures/07_Ceolin/volcano.pdf", width=1.5, height=1.75)
plot(colored)
dev.off()
```
